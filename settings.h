...
enum system_events
{
    ...
    EVENT_GSM_SMS_READ_EXTRACT_MSSG,
    EVENT_GSM_SMS_READ_EXTRACT_TIME,
    EVENT_GSM_PARSING_ERROR,
    ...
    EVENT_GSM_SMS_SEND,
    EVENT_GSM_SMS_RECIEVE_URC,
    EVENT_GSM_SMS_NEW_RECIEVED,
    EVENT_GSM_BUFFER_FULL,

    EVENT_GSM_GPRS_SETUP_DONE,
    EVENT_GSM_GPRS_START_DONE,
    EVENT_GSM_GPRS_SOCKET_OPEN_DONE,
    EVENT_GSM_GPRS_SOCKET_CLOSE_DONE,
    EVENT_GSM_GRPS_CONNECT_RESPONSE,
    EVENT_GSM_GRPS_CLOSE_RESPONSE,
    EVENT_GSM_GPRS_FAILURE,
    EVENT_GSM_GPRS_SETUP,
    EVENT_GSM_GPRS_START,
    EVENT_GSM_GPRS_SOCKET_OPEN,
    EVENT_GSM_GPRS_SEND_DATA,
    EVENT_GSM_GPRS_SEND_DATA_DONE,
    EVENT_GSM_GPRS_SOCKET_CLOSE,
    EVENT_GSM_GPRS_PROMPT,
    EVENT_GSM_GPRS_SEND_ACK,
    EVENT_GSM_GPRS_RESPONSE,
    EVENT_GSM_GPRS_BUFFER_EMPTY,
    EVENT_GSM_GPRS_BUFFER,
    EVENT_GSM_GPRS_REOPEN,
    EVENT_GSM_GPRS_STATUS_RESPONSE,
    /* ADC RELATED EVENTS */
    ...
    /* APPLICATION EVENTS */
    EVENT_APP_ACTION_STATUS,
    EVENT_APP_ACTION_ON,
    EVENT_APP_ACTION_OFF,
...
enum gsm_driver_messages
{
    ...
    GSM_GPRS_CLOSE,
    GSM_GPRS_CONNECT,
    GSM_GPRS_STATUS_INITIAL,
    GSM_GPRS_STATUS_START,
    GSM_GPRS_STATUS_GPRSACT,
    GSM_GPRS_STATUS_STATUS,
    GSM_GPRS_SEND_ACK,
    GSM_GPRS_PROMPT,
